...
enum SeatingPolicyCatalogue {
    static func policies(for scenario: SeatingScenario) -> [SeatingPolicy] {
        ...
        var policies = [
            ...
            SeatingPolicy(kind: .locationPreference, guestIDs: ["mariusz"], tableID: "T1", priority: .location, evidence: "Mariusz is a work-group contact for Bartek and is paired with Sławek by an explicit companion rule.", weight: 20_000),
