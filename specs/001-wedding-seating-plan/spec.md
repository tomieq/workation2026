...
- **FR-009**: The system MUST apply seating constraints in this order: structural validity, mandatory couple placement, explicit guest separation rules, explicit companion rules, location preferences, explicit conversation-volume avoidance, explicit food/drink affinities, then group-membership preferences.
...
- **Seating Policy**: A documented, evidence-backed rule that expresses a mandatory placement, separation, companion, location preference, conversation-avoidance preference, or affinity and its priority.
