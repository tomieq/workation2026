...
- `input/scenario2.json` is the canonical fixture for validating the updated program. Its table-capacity data must be brought into the approved Scenario 2 shape before end-to-end execution.
